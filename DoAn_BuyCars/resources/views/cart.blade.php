    ...
    $(document).ready(function () {
        function updateTotal() {
            ...
            $('.cart-item').each(function () {
                const price = parseFloat($(this).find('.product-price').text().replace('₫', '').replace('.', '').trim());
        ...
        function updateCart(productId, quantity) {
            $.ajax({
                ...
                method: 'POST',
                data: {
                    cartItems: JSON.stringify({ [productId]: { quantity: quantity } }),
